...
@implementation UIButton (FGLEdgeInsets)
...
- (void)fgl_layoutButtonWithEdgeInsetsStyle:(FGLButtonEdgeInsetsStyle)style imageTitlespace:(CGFloat)space {
    ...
    switch (style) {
        case FGLButtonEdgeInsetsStyleImageRight:
        {
        space = space * 0.5;
        ...
        case FGLButtonEdgeInsetsStyleImageLeft:
        {
        space = space * 0.5;
        ...
        titleInsetsRight = -titleInsetsLeft;
            ...
            break;
        case FGLButtonEdgeInsetsStyleImageBottom:
        {
        ...
        titleInsetsBottom = - titleInsetsTop;
            ...
            break;
        case FGLButtonEdgeInsetsStyleImageTop:
        {
        CGFloat imageHeight = CGRectGetHeight(self.imageView.frame);
        CGFloat labelHeight = CGRectGetHeight(self.titleLabel.frame);
        CGFloat buttonHeight = CGRectGetHeight(self.frame);
